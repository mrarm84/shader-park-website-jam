...
function handleGamepadInput() {
    ...
    if (gamepad) {
        ...
        const leftY = gamepad.axes[1]; // -1 to 1

        const speed = 10; // pixels per frame
        virtualCursor.x += gamepad.axes[0] * speed;
        virtualCursor.y += gamepad.axes[1] * speed;
...
// Simulate mousemove
        ...
        // Simulate click with Button 0 (X or A)
        if (gamepad.buttons[0].pressed && !clicking) {
