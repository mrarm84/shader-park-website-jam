...
import { MeshStandardMaterial, Scene, Inspector, Quaternion, WebGLRenderTarget, HalfFloatType , UniformsUtils,
    // ShaderMaterial,
    Color, PerspectiveCamera, Vector2, Vector3, Raycaster, HemisphereLight, TextureLoader, WebGLRenderer, FrontSide, BackSide, BufferGeometry, Line, LineDashedMaterial, CatmullRomCurve3, Group, Mesh, MeshBasicMaterial, IcosahedronGeometry, AdditiveBlending, SubtractiveBlending, MultiplyBlending } from 'three';
...
function setupHalftoneGUI() {
    ...
    const updateHalftoneBlending = function() {
        ...
        // Create new THREE.ShaderMaterial with updated blending properties
...
function init() {
	...
	renderer = new THREE.WebGPURenderer({ antialias: true, preserveDrawingBuffer: true, powerPreference: 'high-performance', alpha: true});
...
renderer.setClearColor(0xffffff, 1);
    ...
    halftonePass.material = new THREE.ShaderMaterial( {
        blending: 0.5,
        // blendMode: MultiplyBlending
    } );
