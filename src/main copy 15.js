...
function handleKeyDown(e) {
    ...
    switch (key) {
        ...
        case 'z':
            ...
            try { generateLinesSetA(0xffffff, 0xff00ff);generateLinesSetA(0xffffff, 0xff00ff);generateLinesSetA(0xffffff, 0xff00ff);generateLinesSetA(0xffffff, 0xff00ff);generateLinesSetA(0xffffff, 0xff00ff);generateLinesSetA(0xffffff, 0xff00ff); } catch(err) { console.error(err); }
            break;
        case 'x':
...
function generateLinesSetA(color = 0xffffff, color2 = 0xff00ff) {
    ...
    const lineCount = 12; // total lines including clones
