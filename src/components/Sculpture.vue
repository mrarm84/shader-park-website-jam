...
export default {
  ...
  mounted() {
    ...
    console.log('PRPRPRP', this.sculpture.mesh)

    // Set renderer mode based on which renderer is active
    const isWebGPU = window.rendererNew && window.rendererNew.constructor.name === 'WebGPURenderer';
    this.sculpture.setRendererMode(isWebGPU);
